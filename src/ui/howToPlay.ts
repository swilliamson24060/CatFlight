const HELP_HTML = `
  ...
  <ol>
    ...
    <li><strong>Doc's Workbench</strong> — This is where everything gets identified. Assign what you found to each of the 6 real categories (a piece good for two, like a cord, can only be claimed by one) — Doc will always assemble something, even from a partial haul, but the closer you get to the blueprint's quotas, the better your odds in the air. Decoration is optional and never required — sparkly extras score bonus points, and a few special "Fly Better" decorations also nudge your stats.</li>
