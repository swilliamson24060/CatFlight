const HELP_HTML = `
  ...
  <ol>
    ...
    <li><strong>The Kitchen</strong> — 5 appliances are available each trip, but you can only search 3 of them before heading back — choose wisely. Click one to search it — you'll only see an object's name and size, not what it's useful for. Keep the ones you want (Rotate to flip, click a grid cell to place in your 5x5 carry grid), Discard the rest. A device might be all scrap, all useful, or a mix — you won't know until Doc looks it over.</li>
    <li><strong>Doc's Workbench</strong> — This is where everything gets identified. Assign what you found to each of the 6 real categories (a piece good for two, like a cord, can only be claimed by one) — Doc will always assemble something, even from a partial haul, but the closer you get to the blueprint's quotas, the better your odds in the air. Decoration is optional and never required — sparkly extras score bonus points, and a few special "Fly Better" decorations also nudge your stats. Not feeling ready? Return to the Kitchen for another trip before you assemble — no flight attempt spent, and everything you've already assigned stays assigned (those pieces lock in the grid, marked with &#128274;, so you can't accidentally pull them back out).</li>
    <li><strong>Test Flight Simulation</strong> — Launch! Your flight's fate is driven by how fully you met the blueprint: well short and you won't get off the ground, partway there and you'll crash mid-flight or miss the landing, and a full match means a clean success. Clearing it wins the run and banks a Score — fewer kitchen trips before a successful flight means a higher Score. A crash doesn't end anything: you head straight back to the kitchen with everything you've already carried, for another trip. Share a successful craft with a code or a downloadable PNG card.</li>
